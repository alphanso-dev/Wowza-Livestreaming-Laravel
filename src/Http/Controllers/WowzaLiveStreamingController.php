...
class WowzaLiveStreamingController extends Controller{
    ...
    */
    ...
    public function WowzaLiveStreamApiStop($wowza_id){
        $url = "/live_streams/$wowza_id/stop";
        $output = RunApi($url, "PUT");
        return $output;
        // $ch = curl_init();
        // curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_DIGEST);
    ...
    public function WowzaLiveStreamApiStatus($wowza_id){
        $url = "/live_streams/$wowza_id/state";
        $output = RunApi($url, "GET");
        return $output;
        // $ch = curl_init();
        // curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_DIGEST);
        // curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    public function WowzaLiveStreamApiIngestAnalyticsData($wowza_id){
        $url = "/analytics/ingest/live_streams/$wowza_id";
        $output = RunApi($url, "GET");
        return $output;
        // $ch = curl_init();
        // curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_DIGEST);
    ...
    public function WowzaLiveStreamApiViewersAnalyticsData($wowza_id){
        $url = "/analytics/viewers/live_streams/$wowza_id";
        $output = RunApi($url, "GET");
        return $output;
        // $ch = curl_init();
        // curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_DIGEST);
